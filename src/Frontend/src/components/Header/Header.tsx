    ...
    return (
        <div className={s.header}>
            ...
            <nav className={`${s.menu} ${open ? s.open : ''}`}>
                <Link to={'/'} onClick={() => setOpen(false)} className={s['menu-item']}>Главная</Link>
                <Link to={'profile'} onClick={() => setOpen(false)} className={s['menu-item']}>Профиль</Link>
                <Link to={'/'} onClick={() => setOpen(false)} className={s['menu-item']}>Активности</Link>
                <Link to={'/'} onClick={() => setOpen(false)} className={s['menu-item']}>Магазин</Link>
            </nav>
